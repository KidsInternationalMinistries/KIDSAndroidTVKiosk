...
Write-Host "Step 2: Cleaning build files..." -ForegroundColor Yellow
# Clean build files that shouldn't be committed
...
Write-Host "Step 3: Adding source code changes..." -ForegroundColor Yellow
...
git add *.md
git add _build_install_publish/
...
$confirm = Read-Host "`nContinue with commit? (y/N)"
...
Write-Host "Step 6: Creating/updating debug release..." -ForegroundColor Yellow
